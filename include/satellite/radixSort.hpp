...
namespace NSM {
    namespace rt {
        ...
        protected:
            ...
            ComputeContext histogram;
            ComputeContext permute;
            ComputeContext workPrefixSum;
            ComputeContext singleRadix;
            DeviceQueueType device;
            BufferType TmpKeys;
            BufferType TmpValues;
            BufferType VarBuffer;
            BufferType Histograms;
            BufferType PrefixSums;
            BufferType VarStaging;
        ...
        public:
            RadixSort() {}
            RadixSort(DeviceQueueType& device, std::string shadersPack) {
                shadersPathPrefix = shadersPack;
                init(device);
            }

            // copying/reference constructor
            RadixSort(RadixSort& another) {
