...
namespace NSM {
    ...
    public:
        ...
        void loadImGuiResources() {
            ...
            // create texture
            fontTexture = createTexture(device, vk::ImageType::e2D, vk::ImageViewType::e2D, { uint32_t(width), uint32_t(height), 1 }, vk::ImageUsageFlagBits::eStorage | vk::ImageUsageFlagBits::eSampled | vk::ImageUsageFlagBits::eTransferDst | vk::ImageUsageFlagBits::eTransferSrc, vk::Format::eR8G8B8A8Unorm, 1);
